...
我承认我可能是标题党了，因为每个人对大的理解肯定是不一样的，更何况我说的是超大。其实就是10TB，对我一个没见过大世面的行业新人和fdisk来说，它确实算大的了，本文介绍对parted的学习和实际使用。<!--more-->
...
> 3. fdisk工具虽然很好用，但对于大于2T以上的硬盘分区特别慢，可能一部分容量识别不了，也不支持非交互模式。
>
...
[parted命令用法详解：创建分区](http://c.biancheng.net/view/905.html)
